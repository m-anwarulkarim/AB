...
import { SignInEmail, SignUpEmail, VoidResult, AuthLoginResult } from "./auth.types";
...
const signInEmail = async (userData: SignInEmail, reqHeaders: Record<string, unknown>): Promise<AuthLoginResult> => {
...
const signOut = async (_reqHeaders: Record<string, unknown>): Promise<VoidResult> => {
    // optional:
