...
import { CreateComboInput, UpdateComboInput } from "./combo.type";
...
export const ComboService = {
    ...
    async createCombo(payload: CreateComboInput) {
    ...
    async updateComboById(id: string, payload: UpdateComboInput) {
    ...
    async toggleComboActive(id: string) {
